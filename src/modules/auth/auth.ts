    ...
    async createUser(profile) {
      ...
      const user = await db.user.create({
        data: {
          ...
          image,
          username,
          emailVerified: emailVerified || null, // Handle email verification status
          phoneNumber: null, // Set as null for now, you might want to ask for it later
          password: null, // Since OAuth users don’t have a password
